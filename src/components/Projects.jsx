...
export default function Projects() {
  ...
  // Filter categories
  const categories = ['All', 'Flutter', 'Full Stack', 'Web'];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-text-gray text-sm md:text-base mt-4 max-w-lg mx-auto">
            A showcase of mobile apps and web platforms built with Flutter, React, and Django.
          </p>
        </div>
                ...
                <div className="p-5 flex flex-col flex-grow justify-between space-y-4">
                  <div className="space-y-2">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      {/* GitHub Icon Link to View Code */}
                      {project.github_link && (
                        <a
                          href={project.github_link}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="p-2 rounded-lg bg-white/5 hover:bg-primary/20 text-text-gray hover:text-primary border border-white/10 hover:border-primary/30 transition-all flex-shrink-0"
